// Code taken from https://github.com/krm104/AndroidSPAAM
...
public class MatrixMathematics {
	 ...
	 * that have inverse is called non-singular or invertible. If the matrix does
	 * not have inverse it is called singular. For a singular matrix the values of
	 * the inverted matrix are either NAN or Infinity Only square matrices have
	 * inverse and the following method will throw exception if the matrix is not
	 * square.
	 * 
	 * @param matrix
	 * @return
	...
	/**
	 * subtract two matrices using the above addition method. Matrices should be the
	 * same dimension.
	 * 
	 * @param matrix1
	 * @param matrix2
